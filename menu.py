...
def draw_arrow(x,x2,y,arrow_push1,arrow_rect1,arrow_push2,arrow_rect2):
    ...
    if arrow_push1>0:
        a+=1
    if arrow_rect1.collidepoint(get_pos):
        a+=2
    ...
    if arrow_push2>0:
        a+=1
    if arrow_rect2.collidepoint(get_pos):
        a+=2
...
font =pygame.font.Font("fonts/NotoSansJP-VariableFont_wght.ttf", 36)
...
def menu():
    ...
    for i in range(tab):
        ...
        if frame_rect[i].collidepoint(get_pos):
    ...
    frame_rect.append(frame.get_rect(topleft=(x,y)))
    if frame_rect[tab].collidepoint(get_pos):
    ...
    if value.play_number<2:
        ...
        value.screen.blit(deck[value.deckcolor[value.decks]], (deckx,decky-x2))
        value.screen.blit(deck[value.deckcolor[value.decks2]], (deckx2,decky-x2))
        if games_rect.collidepoint(get_pos):
    ...
    #デッキ作成
        ...
        if frame4_rect.collidepoint(get_pos):
...
def menu2():
    ...
    if value.play_number<2:
        ...
        if ivent_rect.collidepoint(get_pos):
        ...
        if deck_rect.collidepoint(get_pos):
        ...
        if deck_rect2.collidepoint(get_pos):
        ...
        if deck_change:
            ...
            for i in range(4):
                if change_deck_rect[i].collidepoint(get_pos) and len(value.deck[i])==20:
                    if mouse_check_change_deck[i]==0:
                        mouse_check_change_deck_time[i]=10
                    mouse_check_change_deck[i]=1
                    se_collide(2,10+i)
        ...
        if deck_change2:
            ...
            for i in range(4):
                if change_deck_rect[i+4].collidepoint(get_pos) and len(value.deck[i])==20:
                    if mouse_check_change_deck[i]==0:
                        mouse_check_change_deck_time[i]=10
                    mouse_check_change_deck[i]=1
                    se_collide(2,10+i)
        ...
        if event.type == pygame.MOUSEBUTTONDOWN and event.button == 1:
            if value.play_number<2:
                if deck_change:
                    for i in range(4):
                        if change_deck_rect[i].collidepoint(get_pos) and len(value.deck[i])==20:
                            ...
                            deck_change=False
                            soundplay.se_play(4)
                    if not frame3_rect.collidepoint(get_pos):
                        deck_change=False
                        deck_change2=False
                elif deck_change2:
                    for i in range(4):
                        if change_deck_rect[i+4].collidepoint(get_pos) and len(value.deck[i])==20:
                            ...
                            deck_change2=False
                            soundplay.se_play(4)
                    if not frame3_rect2.collidepoint(get_pos):
                        deck_change=False
                        deck_change2=False
                else:
                    for i in range(tab+1):
                    ...
                    if arrow_rect1[0].collidepoint(get_pos):
                        ...
                        soundplay.se_play(4)
                    elif arrow_rect2[0].collidepoint(get_pos):
                        arrow_push2[0]=5
                        if value.Startinghandsize<Startinghandsize_size-1:value.Startinghandsize+=1
                        soundplay.se_play(4)
                    elif arrow_rect1[1].collidepoint(get_pos):
                        arrow_push1[1]=5
                        if value.firstplayer>0:value.firstplayer-=1
                        soundplay.se_play(4)
                    elif arrow_rect2[1].collidepoint(get_pos):
                        arrow_push2[1]=5
                        if value.firstplayer<firstplayer_size-1:value.firstplayer+=1
                        soundplay.se_play(4)
                    elif games_rect.collidepoint(get_pos):
                        value.fade_out = True
                        value.fade_in = False
                        value.nextstep=3
                        soundplay.se_play(5)
                    elif deck_rect.collidepoint(get_pos):
                        deck_push=4
                        mouse_check_deck_time=0
                        deck_change=True
                        soundplay.se_play(4)
                    elif deck_rect2.collidepoint(get_pos):
                        deck_push2=4
                        mouse_check_deck_time2=0
                        deck_change2=True
                        soundplay.se_play(4)
                    elif ivent_rect.collidepoint(get_pos):
                ...
                if arrow_rect1[2].collidepoint(get_pos):
                    ...
                    soundplay.se_play(6)
                elif arrow_rect2[2].collidepoint(get_pos):
                    arrow_push2[0]=5
