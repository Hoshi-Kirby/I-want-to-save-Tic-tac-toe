...
def bgm_play(x):
    if value.bgm_track != x:
        match(x):
            case 1:
                pygame.mixer.music.load(f"sound/op.ogg")
                pygame.mixer.music.set_volume(0.1)
            case 2:
                pygame.mixer.music.load(f"sound/mm.ogg")
                pygame.mixer.music.set_volume(0.05)
            case 3:
                pygame.mixer.music.load(f"sound/vs.ogg")
                pygame.mixer.music.set_volume(0.05)  
            case 4:
                pygame.mixer.music.load(f"sound/mk.ogg")
